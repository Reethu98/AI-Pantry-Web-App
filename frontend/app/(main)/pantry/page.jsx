        ...
        <div className="container mx-auto max-w-5xl">
            <div className="mb-4">
                ...
                onClick={() => setIsModelOpen(true)}
                 className="hidden md:flex bg-orange-600 hover:bg-orange-700 text-white gap-2" size="lg">
            ...
            {/* Quick Action Card -  Final Recipes */}
            {items.length > 0 && (
          <Link href="/pantry/recipes" className="block mb-8">
            <div className="bg-linear-to-r from-orange-600 to-amber-500 text-white p-6 border-2 border-stone-200 hover:shadow-lg hover:-translate-y-1 transition-all cursor-pointer group">
          ...
          <div className="mt-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {items.map((item) => (
                <div
                  key={item.documentId}
                  className="w-full max-w-md bg-white p-4 border-2 border-stone-200 hover:border-orange-600 hover:shadow-lg transition-all"
                >
                  {editingId === item.documentId ? (
                    ...
                    <div className="space-y-2">
                      <input
                        ...
                        className="w-full px-3 py-1.5 border-2 border-stone-200 focus:outline-none focus:border-orange-600 text-sm"
                      ...
                      <div className="flex gap-2">
                        <Button
                          ...
                          onClick={saveEdit}
                          disabled={updating}
                          className="flex-1 border-2 bg-green-50 hover:bg-green-90 border-green-700"
                        >
                          {updating ? (
