...
function RecipeContent() {
  ...
  if (!recipeName) {
    return (
      <div className="min-h-screen bg-stone-50 pt-24 pb-16 px-4" style={{paddingTop:"48px"}}>
            ...
            <div className="bg-white p-8 border-2 border-stone-200">
              ...
              <div>
                {recipe.instructions.map((step, index) => (
                  ...
                  >
                    {/* Step Number */}
                    <div className="absolute -left-5 top-0 w-10 h-10 flex items-center justify-center font-bold border-6 border-orange-700">
                      {step.step}
                    </div>
